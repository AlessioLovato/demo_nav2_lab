...
from launch.actions import DeclareLaunchArgument, IncludeLaunchDescription, ExecuteProcess, GroupAction, OpaqueFunction, SetLaunchConfiguration, SetEnvironmentVariable
...
def generate_launch_description():
    ...
    arg_launch_arguments = [
        ...
        DeclareLaunchArgument('world_file', default_value=os.path.join(get_package_share_directory('demo_nav2_lab'), 'worlds/lab.sdf'))
    ]
    ...
    gazebo_group = GroupAction([
        ...
        Node(
            ...
            executable='create',
            name='urdf_spawner',
            parameters=[{'string': ParameterValue(robot_description_gz, value_type=str), 'x': -1.0, 'y': 3.0, 'z': 1.0}]
        ),
